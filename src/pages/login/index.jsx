...
import { Input, Button, MessageError, LoadingComponent } from "../../components/";
...
const Login = () => {
  ...
  const schema = yup.object({
   ...
   // Importando algumas propriedades do hookform e usando o userForm
  const {
  ...
  return (
    <Main>
      <Body>
        ...
        {!loading && (<form onSubmit={handleSubmit(loginUser)}>
