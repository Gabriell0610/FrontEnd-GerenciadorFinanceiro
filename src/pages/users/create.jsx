...
import {Content, Input, MessageError, Button, LoadingComponent} from "../../components"
...
const create = () => {
    ...
    return (
        <Content>
          ...
          {!loading &&  <form onSubmit={handleSubmit(save)}>
                <Input 
                label="Name"
                ...
                <ActionButtonDiv>
                    ...
                    <Button value="Cancelar" variant="btn-warning" onClick={() => navigate("/user")}/> 
                </ActionButtonDiv>
